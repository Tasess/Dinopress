...
{
  modal.innerHTML='<div class="gamemodalPopup"><span class="gameclose" onclick="closeModal()">X</span><div class="gamecontent"><div class="gameinfoTitle">'+vidObj[x].title+'</div><div class="gamevidSyn"><object id="gamevideo" width="420" height="315" data="'+vidObj[x].video+'"></object><div class="gameinfoSynop">'+vidObj[x].synop+'</div></div></div></div></div>';
